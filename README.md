...
[![License: WTFPL](https://img.shields.io/badge/License-WTFPL-brightgreen.svg)](https://www.wtfpl.net/)
...
This project is licensed under the [WTFPL](https://www.wtfpl.net/) — see the [LICENSE](LICENSE) file for details.

...
const { adminUpdate, getById } = useExperiences()
...
const { data } = await useAsyncData(
  () => `admin-experience-${experienceId.value}`,
  () => getById(experienceId.value!),
)
...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <h1 class="editorial-heading text-2xl text-[var(--text-primary)]">Edit Experience</h1>

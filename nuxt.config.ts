  ...
  icon: {
    ...
    clientBundle: {
      ...
      icons: [
        ...
        'lucide:image-plus', 'lucide:italic', 'lucide:layout-dashboard', 'lucide:link',
        'lucide:linkedin', 'lucide:list', 'lucide:list-ordered', 'lucide:log-out',
        'lucide:map-pin', 'lucide:minus', 'lucide:monitor', 'lucide:moon', 'lucide:panel-left',
        'lucide:pencil', 'lucide:plus', 'lucide:quote', 'lucide:refresh-cw', 'lucide:square-code',
        'lucide:star', 'lucide:strikethrough', 'lucide:sun', 'lucide:tag', 'lucide:trash',
        'lucide:trash-2', 'lucide:twitter', 'lucide:upload', 'lucide:user', 'lucide:x',
      ],
    },
  },
